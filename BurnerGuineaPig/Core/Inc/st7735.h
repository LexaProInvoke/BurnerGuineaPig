...
/////////////////////////////////////////////////////////////////картинки за номером
#define ChargeStartImage 		1
#define ChargeOverImage  		2
#define PlagInImage		 		3
#define ConnectorRemovedImage   4
#define WaitForTheStartImage    5
#define ChargingImage			6
#define ErrorGroundImage		7
#define OverCurrentFail 		8
#define UnderVoltageFail		9
#define OverVoltageFail			10
#define VoltageGroundFail		11
#define PilotSignalcharger      12
//////////////////////////////////////////////////////////////////
...
#define	ST7735_DATA_ROTATION	(ST7735_MADCTL_MX  | ST7735_MADCTL_MV | ST7735_MADCTL_RGB)
...
void ST7735_DrawRusString(uint16_t x, uint16_t y,  uint16_t* str, FontDef font, uint16_t color, uint16_t bgcolor);
